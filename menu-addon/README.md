# Learned Skills Menu Addon v1.1.0
...
> [!WARNING]
> This package supports only Severed Chains `3.0.0-1780-devbuild`, commit `d3d4c02cbf1c74a4db39cfc10520431a6b8cc150`. Do **not** update Severed Chains while it is installed. Uninstall the Menu Addon **before** updating Severed Chains.
...
Install the v1.1.0 core JAR first. In the player package, run `Verify Menu Addon.bat`, then `Install Menu Addon.bat`. The installer requests the game directory, verifies all relevant hashes, shows the mandatory warning, and requires typing `INSTALL`.
...
Corresponding modified source: <https://github.com/IntiArtHub/Severed-Chains/tree/learned-skills-menu-v1.1.0>. The release ZIP also includes the exact patch, build instructions, engine baseline, third-party notice, and AGPL licence.
